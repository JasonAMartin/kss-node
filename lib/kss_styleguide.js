...
//console.log("data----------------------------------", this.data);
	...
	for (i = 0; i < l; i += 1) {
		...
		if (sectionQueryMatch(current.data.reference, query) || !sectionQueryMatch(current.data.reference, query) && sectionQueryMatch(current.data.reference, query)!="null") {
...
sectionQueryMatch = function(reference, query) {
	...
	var refCheck = match && match[0] === reference;
